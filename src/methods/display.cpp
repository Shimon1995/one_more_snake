...
void Display::display() {
  ...
  mvprintw(16, this->display_height + 30, "space - pause the game.");

  mvprintw(20, this->display_height + 18, "Rules:");
  mvprintw(22, this->display_height + 14, " If you either lose all the hearts or collide your tail till");
  mvprintw(25, this->display_height + 14, "you have less then 5 score points, you lose.");
  mvprintw(27, this->display_height + 14, "To win the game gain more then 20 score points.");
